...
class LEDController:
    def __init__(self,
        ...
        if driver.is_raspberrypi():
            # Map pixel order strings to constants
            px_order_map = {
                'RGB': driver.WS2811_STRIP_RGB,
                'RBG': driver.WS2811_STRIP_RBG,
                'GRB': driver.WS2811_STRIP_GRB,
                'GBR': driver.WS2811_STRIP_GBR,
                'BRG': driver.WS2811_STRIP_BRG,
                'BGR': driver.WS2811_STRIP_BGR,
                'RGBW': driver.SK6812_STRIP_RGBW,
                'RBGW': driver.SK6812_STRIP_RBGW,
                'GRBW': driver.SK6812_STRIP_GRBW,
                'GBRW': driver.SK6812_STRIP_GBRW,
                'BRGW': driver.SK6812_STRIP_BRGW,
                'BGRW': driver.SK6812_STRIP_BGRW,
            }
            px_order = px_order_map.get(led_pixel_order, driver.WS2811_STRIP_GRB)
